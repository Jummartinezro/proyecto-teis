...
public class CustomerServiceImpl implements ICustomerService {
    ...
    public Customer update(Customer entity) throws Exception {
        ...
        if (entity.getGender() == null) {
            throw new RequiredAttributeException("Trying to put a null gender");
        } else if (isChangingGender(entity)) {
            ...
            //TODO discutir si por defecto hacer la mailing list false en vez de nula cuando esto ocurra
            ...
            throw new RequiredAttributeException("Trying to put a null Mail!");
